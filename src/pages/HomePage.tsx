      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto mb-10">
            Une base React + Vite optimisée pour Vercel. Minimaliste,
            performante et prête pour vos prochains grands projets.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-24">
          {[
            {
              title: 'Vite 6+',
              desc: 'Démarrage instantané et Hot Module Replacement ultra-rapide.',
            },
            {
              title: 'Tailwind 4',
              desc: 'Design utilitaire pour une flexibilité totale sans quitter votre HTML.',
            },
            {
              title: 'Vercel Native',
              desc: 'Déploiement en un clic avec intégration continue automatique.',
            },
          ].map((feature, i) => (
            <div
              key={i}
